...
const FormAddEventCreation = ({ 
  ...
  return (
	...
	,
		  ...
		  itemsEvents={[
		    <Button id="_VjONVF1yEfGDTcMRWoUIdw" key="Submit" type="submit" variant="primary">Submit</Button>
	    ]}
	  />
...
export default FormAddEventCreation
